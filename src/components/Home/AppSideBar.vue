<template>
  <aside class="sidebar">
    <a v-for="category in categories" :key="category.id" class="sidebar-item" href="#" @click.prevent="$emit('changedCategory', category.id)">
      <svg
    ...
    <a class="sidebar-item" href="#" @click.prevent="$emit('changedCategory', null)">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="fill-current mr-3"
        height="24"
